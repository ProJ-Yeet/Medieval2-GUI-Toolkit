...
and it is reported wherever it is - comment, string or doc - not just in UI text.
    ...
    python dev/checks/prose_check.py            # a summary and the worst offenders
    python dev/checks/prose_check.py --all      # every hit
    python dev/checks/prose_check.py --file web/js/home.js
