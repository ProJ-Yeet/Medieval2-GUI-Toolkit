...
it walks the bytes instead, which is what you want when a file will NOT decode.
    ...
    python dev/diagnose/meshdump.py <file.mesh> [more files...]
    python dev/diagnose/meshdump.py --raw <file.mesh>       # byte-level walk
    python dev/diagnose/meshdump.py --sweep <folder>        # decode every .mesh under it
