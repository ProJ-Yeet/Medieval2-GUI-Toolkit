"""Index the TWCenter tutorial archive so a format question has one place to look.
    ...
    python dev/reference/twc_index.py              # rebuild the index
    python dev/reference/twc_index.py --check      # report what would change, write nothing
...
def render_md(index: dict) -> str:
    ...
    out = [
        ...
        "`dev/reference/twc_index.py`. Rebuild after adding tutorials: "
        "`python dev/reference/twc_index.py`.",
        "",
