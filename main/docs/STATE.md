...
`--latest` (latest **v2.3.9**, 2026-09-25). **Campaign-map** -> the **beta
line**, uploaded as a **pre-release** (latest **beta 2026-09-25**). A
...
`master` carries the map ON, and `__version__` says `beta-2026-09-25`
