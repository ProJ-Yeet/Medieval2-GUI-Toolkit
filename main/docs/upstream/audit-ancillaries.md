...
`docs/upstream/SYNC_LOG.md`: `src/components/ancillaries/{AncillariesParser,
...
as `docs/upstream/audit-traits.md` - their serializer rewrites the whole file - because
...
**Their trigger half**, for the reason in `docs/upstream/audit-trigger-vocab.md`:
